...
+ YAML header for further customisation.
...
The `index.qmd` contains the contents of your slides as well as a YAML header which we've just been editing.
...
+ Configurations options in YAML header of `index.qmd`.
